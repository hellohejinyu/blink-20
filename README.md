...
**Protect your vision with the scientifically-backed 20-20-20 rule.**

Blink 20 is a sleek, intelligent eye-care assistant for VS Code tailored for developers who spend hours coding. It seamlessly integrates into your workflow to prevent digital eye strain without breaking your concentration.

---

## What is the 20-20-20 Rule?

The [American Optometric Association](https://www.aoa.org/) recommends:
> **Every 20 minutes**, take a **20-second break** and focus your eyes on something **20 feet (6 meters) away**.

This simple habit relaxes the focusing muscles inside the eye, reducing fatigue and preventing long-term damage.
...
- **Chinese (简体中文)**: 完美支持中文界面，符合中文用户习惯。

---

## Usage

1. **Install**: Search for "Blink 20" in the VS Code Marketplace and install.
